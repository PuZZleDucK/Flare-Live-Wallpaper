...
//	private float stage3Time;
	...
	{
		int firstExplosionMin = 15;
		int firstExplosionMax = 10;
		int secondExplosionMin = 12;
		int secondExplosionMax = 10;
		//flareAlpha = 255;
		rng = new Random();
		x = inx;
		y = iny;
		...
		time = 0;
		//triggerTime = 50;
		setStage1Time(30 + rng.nextInt(70)); //, rocket height
		setStage2Time(10 + rng.nextInt(30));
	...
	public void render(Canvas c, Paint mPaint)
	{
	    ...
	    if (this.getTime() > this.getStage1Time() && this.getTime() <  this.getStage1Time() + this.getStage2Time() )//+ this.getStage2Time()) { // + this.getStage2Time()) {
				{
				//stage 2
				mPaint.setColor(this.getColor1());
				this.incrementExplosionRadius(4);
		...
		if(this.getTime() > this.getStage1Time() + this.getStage2Time() )//+ this.getStage3Time())
		{
					...
					this.incrementExplosion2Radius(2);
...
//	}
	...
	public void incrementExplosion2Radius(int x) {
		this.explosion2Radius += x;
